...
function convert(idlString_1) {
    return __awaiter(this, arguments, void 0, function (idlString, convertOptions) {
        var options, idl, ts, tsString;
        if (convertOptions === void 0) { convertOptions = {}; }
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    options = __assign({ emscripten: false, module: 'Module', defaultExport: false }, convertOptions);
